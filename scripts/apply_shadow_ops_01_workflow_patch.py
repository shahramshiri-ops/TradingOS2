...
TOKEN = "scripts/run_sig_shadow_ops_01.py"
reports = []
...
for wf in WORKFLOWS:
    ...
    if not patched:
        ...
        report["note"] = "patched_after_existing_shadow_step"

    backup = wf.with_suffix(wf.suffix + ".bak_shadow_ops_01")
    backup.write_text(original, encoding="utf-8")
    wf.write_text(text, encoding="utf-8")
    report["patched"] = True
    reports.append(report)

out = ROOT / "proofs/shadow_ops_01_workflow_patch_result.json"
out.parent.mkdir(parents=True, exist_ok=True)
payload = {
    "patch_name": "SHADOW_OPS_01_WORKFLOW_PATCH",
