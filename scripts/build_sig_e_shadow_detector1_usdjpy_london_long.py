# SIG-E-RUNTIME-SHADOW-DETECTOR1 H1 OHLC HISTORY HOTFIX
...
def regime_check(surface, source_path):
    ...
    return session == "LONDON" and align_ok and vol_ok and not missing, {
...
def build():
    ...
    result["shadow_event_id"] = "SIGE_SD1_USDJPY_LONDON_LONG_" + iso(trigger_bar["ts"]).replace("-", "").replace(":", "").replace("Z", "")
