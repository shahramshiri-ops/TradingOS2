...
PROGRAM = "SIG-E-SHADOW-LANE1B-STATUS-HOTFIX1-EXTRA-VALIDATION"
...
OUT = Path("outputs/_sig_e_shadow_lane1b_status_hotfix1/sig_e_shadow_lane1b_status_hotfix1_extra_validation_result.json")
...
def main():
    ...
    print("SIG_E_SHADOW_LANE1B_STATUS_HOTFIX1_EXTRA_VALIDATION_" + result["validation_status"])
    if errors:
        for e in errors:
            print("ERROR:", e)
        raise SystemExit(1)
